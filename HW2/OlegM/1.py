...
print(f"Count of 'better' in 'Zen of python': {count_better}")
count_never = zen_of_python.lower().count('never')
print(f"Count of 'never' in 'Zen of python': {count_never}")
count_is = zen_of_python.lower().count('is')
print(f"Count of 'is' in 'Zen of python': {count_is}")

print()

print("'Zen of python' by upper:")
